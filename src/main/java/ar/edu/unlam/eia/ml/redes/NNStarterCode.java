...
//        recordReader.initialize(new FileSplit(new ClassPathResource("datasets/genoma.csv").getFile()));
        recordReader.initialize(new FileSplit(new ClassPathResource("<INSERT PATH>").getFile()));
        ...
        DataSetIterator iterator = new RecordReaderDataSetIterator(recordReader, datasetSize, labelIndex, numClasses, 1);
        ...
        long seed = 0; // Su numero de alumno
